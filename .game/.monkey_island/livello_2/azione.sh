...
echo Buona fortuna !
echo
cp -r $CURRENT_DIR/.$GAME/livello_3 $CURRENT_DIR/
cd ../livello_3
}
...
if [ -e ../livello_1/equipaggiamento/vanga ] ; then
vanga
fi

if [ -e ../livello_1/equipaggiamento/boccale_di_grog ] ; then
boccale_di_grog
fi

if [ -e ../livello_1/equipaggiamento/mentine_per_alito ] ; then
mentine_per_alito
fi

if [ -e ../livello_1/equipaggiamento/idolo_del_governatore ] ; then
idolo_del_governatore
fi

if [ -e ../livello_1/equipaggiamento/pollo_di_gomma ] ; then
vabene
fi

}

if [ -e ../livello_1/equipaggiamento/idolo_del_governatore ]|| [ -e ../livello_1/equipaggiamento/vanga ] || [ -e ../livello_1/equipaggiamento/mentine_per_alito ] || [ -e ../livello_1/equipaggiamento/boccale_di_grog ] || [ -e ../livello_1/equipaggiamento/pollo_di_gomma ]; then 
